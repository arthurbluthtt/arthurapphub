...
import { removeAnime } from '../../../lib/anime/store';
import { animeUsername, jsonError, readJsonObject } from '../../../lib/anime/api';
...
export const POST: APIRoute = async ({ request }) => {
  ...
  const ok = await removeAnime(env.AUTH_DB, username, id);
